...
| Capability | frontend-engineer | tailwind-daisyui-expert |
|------------|-------------------|-------------------------|
| **React/Vue/Angular** | ✓ Modern frameworks | ✓ React/Vue integration |
...
- **Frontend**: 2 agents (frontend-engineer, tailwind-daisyui-expert)
