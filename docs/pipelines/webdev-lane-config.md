# Webdev Lane Config – OS 2.0

**Purpose:** Shared configuration for the webdev (frontend) lane.  
Used by: `/orca`, `frontend-builder-agent`, `frontend-layout-analyzer`,
...
For `frontend-builder-agent` specifically:
...
These behaviors should be enforced via the webdev pipeline spec and standards.
