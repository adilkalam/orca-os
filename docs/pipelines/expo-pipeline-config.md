# Expo Pipeline Config – OS 2.2

**Purpose:** Shared configuration for the Expo / React Native pipeline.  
...
## 4. Gate Thresholds (ExpoPipeline)
...
- Agents should:
  - Use this file for pipeline-level assumptions (stack, commands, thresholds).
