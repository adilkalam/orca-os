# OS 2.2 – Codex Session Summary (2025-11-19)

This file summarizes the changes and decisions from a Codex CLI session
focused on OS 2.2 agents, pipelines, and docs. Future sessions can load this
...
- Updated `docs/architecture/seo-orca.md`:
  ...
  - Clarified that CLI-only workflows (e.g., `seo_auto_pipeline.py`) are
    implementation details; OS 2.2 prefers `/seo-orca` + pipeline spec.

**Docs Index & Historical Labeling**
- Added `docs/README.md`:
  - Lists core OS 2.2 docs (architecture, pipelines, design, memory,
...
When resuming work on OS 2.2 in future sessions:
...
This should be enough to reload the mental model of the OS 2.2 agent/pipeline
