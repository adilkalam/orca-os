...
- Existing OS 2.2 status/log docs in `docs/`

Treat this as a design-side codex for turning OS 2.2 into an actual, shippable system—not a spec. When points stabilize, they should be promoted into the architecture docs and command/agent implementations.
...
- That matches what OS 2.2 wants to be: not “a cool orchestrator,” but a *portable, inspectable process* around Claude/Codex:
...
- OS 2.2 already has the vocabulary for this:
...
- Key patterns worth importing into OS 2.2:
...
- OS 2.2 can mirror these patterns at a lighter weight:
...
- OS 2.2 can use them as:
  ...
  - Similar domain agents already exist in Agentwise; OS 2.2 can keep:
...
- RA methodology + your current OS 2.2 docs both want:
...
- Minimal, implementable version for OS 2.2:
...
- From SDD and OS v2 brainstorm:
  ...
  - OS 2.2 doesn’t need to over-engineer this:
...
- OS 2.2 can reuse these ideas at a lighter weight:
...
- Slash commands:
  ...
  - Where OS 2.2’s process actually lives.
- MCP:
...
- Skills:
  ...
  - Especially good for per-project “tool belts” that OS 2.2 can assume exist.
...
## 9. Suggested Implementation Order for OS 2.2
...
- The material you’ve collected is enough to build a genuinely differentiated OS 2.2:
...
Once that one pipeline feels “impossible to produce ugly/low-quality output,” OS 2.2 stops being an idea and starts being a working, opinionated operating system for AI development. 
