...
**claude-vibe-config** is ONLY the meta-orchestrator. It provides TOOLS and AGENTS.
...
**claude-vibe-config does NOT have its own design-system.md.** It just provides the tools YOU use IN YOUR projects.
...
│   └─> Generated by: ~/claude-vibe-config/tools/design-system-viewer.sh --open
...
**Who creates:** Auto-generated by running `~/claude-vibe-config/tools/design-system-viewer.sh` FROM YOUR PROJECT
...
# Generate HTML
~/claude-vibe-config/tools/design-system-viewer.sh

# Generate and open in browser
~/claude-vibe-config/tools/design-system-viewer.sh --open
```
...
3. **Create JSON DNA FOR YOUR PROJECT:**
   ...
   # Copy structure from ~/claude-vibe-config/docs/DESIGN_DNA_SYSTEM.md
...
4. **Verify enforcement IN YOUR PROJECT:**
   ...
   ~/claude-vibe-config/tools/ui-guard.sh .
...
│   │   Generated by: ~/claude-vibe-config/tools/design-system-viewer.sh
│   │
...
~/claude-vibe-config/tools/design-system-viewer.sh           # Generate only
~/claude-vibe-config/tools/design-system-viewer.sh --open    # Generate and open
```
...
~/claude-vibe-config/tools/ui-guard.sh .                     # Check DNA exists + layout laws
~/claude-vibe-config/tools/AutoTokenLint.swift .             # Check DNA exists + token usage
```
