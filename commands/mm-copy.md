---
description: "MM Copy — generate brand-calibrated ad copy variants per SKU using craft+benefit, authority quotes, and occasion hooks"
allowed-tools: [Read, Grep, Glob, Write, TodoWrite, AskUserQuestion, WebFetch]
argument-hint: "[optional] SKU/handle list or 'top:20'"
---

# /mm-copy — Marina Moscone Copywriter
