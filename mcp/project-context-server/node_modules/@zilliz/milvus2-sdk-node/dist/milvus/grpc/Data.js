...
class Data extends Collection_1.Collection {
    ...
    _insert(data, upsert = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const buildColumnData = (fields) => Array.from(fields.values()).map(field => {
                var _a;
                ...
                const dataKey = (0, __1.getDataKey)(field.type);
                const elementTypeKey = (0, __1.getDataKey)(field.elementType);
